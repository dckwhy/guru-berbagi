    ...
    <v-row wrap>
      ...
      <v-col cols="12">
        <m-grid
          ...
          "
          @filter="filter"
          :filterBy="this.jenis || this.mapel || this.status || this.bobot || this.tanggal || this.plagiat ?  [jenis, status, bobot, tanggal, plagiat, mapel] : null"
...
export default {
  ...
  data() {
    return {
      ...
      more_menu: [
        ...
        // },
        {
          title: "Kurasi Plagiarisme",
          click: (i, o) => this.cekPlagiarism(o, "set"),
          check: (i, o) =>
            o.status.id == 2 &&
            !o.statuskurasiplagiat &&
            isCan("kurasi_plagiat") &&
            this.current_user.is_kurator_plagiat
        },
        {
          title: "Batal Kurasi Plagiarisme",
          click: (i, o) => this.batalSetPlagiat(o),
          check: (i, o) =>
            o.statuskurasiplagiat &&
            isCan("kurasi_plagiat") &&
            this.current_user.is_kurator_plagiat
      ...
      const conf = [
        ...
        },
        {
          ...
          contents: [
            {
              component: 'p',
              class: 'ma-0 subtitle-2 error--text',
              text: 'Plagiat',
              conditional: {
            ...
            {
              component: 'p',
              class: 'ma-0 subtitle-2 success--text',
              text: 'Lulus Plagiat',
              conditional: {
            ...
            {
              component: 'p',
              class: 'ma-0 subtitle-2 info--text',
  ...
  mounted() {
    this.checkQuery();
    if (this.current_user && this.current_user.is_kurator_plagiat) {
      this.plagiat = null
    }
  },
  methods: {
